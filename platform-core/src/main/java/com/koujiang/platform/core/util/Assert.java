package com.koujiang.platform.core.util;

import com.koujiang.platform.core.exception.DataException;
...
public class Assert {
    ...
    /**
     * Assert a boolean expression, throwing an {@code DataException}
     * if the expression evaluates to {@code false}.
     * <p>Call {@link #isTrue} if you wish to throw an {@code DataException}
     * on an assertion failure.
     * <pre class="code">Assert.state(id == null, "The id property must not already be initialized");</pre>
     * @param expression a boolean expression
     * @param message the exception message to use if the assertion fails
     * @throws DataException if {@code expression} is {@code false}
     */
    ...
    public static void state(boolean expression, Supplier<String> messageSupplier) {
        if (!expression) {
            throw new DataException(nullSafeGet(messageSupplier));
        }
    }
     ...
     * @param message the exception message to use if the assertion fails
     * @throws DataException if the object is not {@code null}
     */
     ...
     * @param object the object to check
     * @param message the exception message to use if the assertion fails
     * @throws DataException if the object is {@code null}
     */
     ...
     * @param message the exception message to use if the assertion fails
     * @throws DataException if the text is empty
     ...
     * @param text the String to check
     * @param message the exception message to use if the assertion fails
     * @throws DataException if the text does not contain valid text content
     ...
     * @param message the exception message to use if the assertion fails
     * @throws DataException if the text contains the substring
     */
     ...
     * @param message the exception message to use if the assertion fails
     * @throws DataException if the object array is {@code null} or contains no elements
     */
     ...
     * @param array the array to check
     * @param message the exception message to use if the assertion fails
     * @throws DataException if the object array contains a {@code null} element
     */
     ...
     * @param message the exception message to use if the assertion fails
     * @throws DataException if the collection is {@code null} or
     ...
     * @param message the exception message to use if the assertion fails
     * @throws DataException if the map is {@code null} or contains no entries
     */
     ...
     * @throws DataException if the object is not an instance of type
     */
     ...
     * @throws DataException if the classes are not assignable
     */
